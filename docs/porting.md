...
| Architect consultation | Subagents (16 generic + project-declared domain architects) | The `/plan` protocol walks the architect council sequentially in one context |
